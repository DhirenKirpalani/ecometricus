  ...
  return (
    <div className="min-h-screen bg-brand-dark">
      ...
      <section className="relative overflow-hidden border-b border-white/5 min-h-[420px] sm:min-h-[540px] flex items-center">
        ...
        {/* Left — text */}
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 py-16 sm:py-28 w-full">
          <div className="max-w-xl lg:max-w-[45%]">
            <p className="text-[9px] sm:text-xs font-bold uppercase tracking-[0.3em] sm:tracking-[0.4em] text-brand-gold mb-4">{t('about.poweredBy')}</p>
            <h1 className="text-2xl sm:text-5xl lg:text-6xl xl:text-7xl font-geometric font-bold text-white uppercase leading-[1.15] sm:leading-[1.1] mb-6">
              {t('about.theVision')} <span className="text-brand-gold">{t('about.vision')}</span>
            </h1>
            <p className="text-sm sm:text-2xl text-gray-300 font-light leading-relaxed mb-8">
              {t('about.heroDesc')}
            </p>
      ...
      <section className="py-14 sm:py-28 bg-[#1c3933] border-b border-white/5 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 items-center">
            <div>
              <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.3em] sm:tracking-[0.4em] text-brand-eco/70 mb-4">{t('about.hiddenProblem')}</p>
              <h2 className="text-2xl sm:text-4xl font-geometric font-black text-brand-gold leading-tight mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {gorillaMetrics.map((m, i) => (
                <div key={i} className="relative group border border-brand-gold/10 hover:border-brand-eco/40 rounded-2xl p-4 sm:p-5 bg-brand-dark/60 transition-all duration-300 overflow-hidden">
                  ...
                  <div className="text-xl sm:text-2xl font-geometric font-black text-white mb-1">{m.value}</div>
      ...
      <section className="py-14 sm:py-28 bg-brand-dark border-b border-white/5">
        <div className="max-w-7xl mx-auto px-5 sm:px-6">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <h2 className="text-2xl sm:text-4xl font-geometric font-black text-white uppercase tracking-wide mb-4">
              {t('about.whyFBRemains')} <span className="text-brand-gold">{t('about.criticalESGGap')}</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-5">
            {pillars.map((p, i) => (
              <div key={i} className="group relative border border-brand-gold/10 hover:border-brand-gold/35 rounded-2xl p-6 sm:p-8 bg-[#1c3933] transition-all duration-400 flex flex-col gap-5 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 items-center">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="p-5 sm:p-8 rounded-2xl border border-brand-gold/10 bg-brand-dark/60 flex flex-col items-center justify-center text-center gap-2 hover:border-brand-gold/25 transition-colors">
              ...
              <div className="col-span-2 p-5 sm:p-8 rounded-2xl border-2 border-brand-eco/50 bg-brand-eco/8 flex flex-col items-center justify-center text-center gap-3 shadow-[0_0_40px_rgba(119,177,57,0.08)]">
            ...
            <div className="space-y-6">
              <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.3em] sm:tracking-[0.4em] text-brand-eco/70">{t('about.ghgCompliance')}</p>
              <h2 className="text-2xl sm:text-4xl font-geometric font-black text-white leading-tight">
      ...
      {/* ─── Industry Insights ─────────────────────────────── */}
      <section className="py-14 sm:py-28 bg-brand-dark">
        <div className="max-w-7xl mx-auto px-5 sm:px-6">
          <div className="text-center mb-10 sm:mb-14">
            <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.3em] sm:tracking-[0.4em] text-brand-gold/70 mb-3">{t('about.standardsFrameworks')}</p>
            <h2 className="text-2xl sm:text-4xl font-geometric font-black text-white uppercase tracking-wide mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
            {insights.map((item, i) => (
              <div key={i} className="group border border-brand-gold/10 hover:border-brand-gold/30 rounded-2xl p-5 sm:p-6 bg-[#1c3933] flex flex-col gap-4 transition-all duration-300">
